            ...
            <header className="border-b border-gray-200">
                <div className="container mx-auto flex items-center justify-between px-4 py-3">
                    <div className="flex items-center">
                        <Link href="/" className="text-red-600 font-serif font-bold text-3xl">
                            fs
                        </Link>
                    </div>
                ...
                <section className="py-10 md:py-14 border-b border-gray-200">
                    <div className="container mx-auto px-4 max-w-4xl">
                        ...
                        <p className="text-gray-700 mb-6 text-base leading-relaxed max-w-2xl">
                            ...
                            Prescribed Chapter 1 of our recent New York Times best- selling book, clear thinking: turning ordinary
                            approaches into extraordinary results.
                        </p>
                    ...
                    <div className="container mx-auto px-4 max-w-6xl">
                        <div className="flex flex-col md:flex-row">
                            <div className="md:w-2/3 pr-0 md:pr-8">
                                <h2 className="text-2xl font-bold mb-4">Explore Farnam Street Articles</h2>
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm mb-2 leading-relaxed">
                                            How to use mental models to make better decisions and avoid cognitive biases.
                                        </p>
                                    </div>
                                    <div>
                                        <h3 className="text-xl font-bold mb-2">Reading Better</h3>
                                        <p className="text-gray-600 text-sm mb-2 leading-relaxed">
                                            Improve critical comprehension and recall, and read with purpose.
                                        </p>
                                    </div>
                                    <div>
                            ...
                            <div className="md:w-1/3 mt-8 md:mt-0">
                                <div className="bg-gray-50 p-6 rounded">
                                    ...
                                    <p className="text-gray-600 text-sm leading-relaxed">Learn faster and master complex topics.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-4 max-w-6xl">
                        <div className="flex flex-col md:flex-row gap-8">
                            <div className="md:w-1/3">
                                <div className="bg-red-600 p-6 rounded text-white">
                                    ...
                                    <p className="text-sm mb-4 leading-relaxed">
                                        Conversations with the world's top performers to extract the tactics, tools, and routines you can
                                        use.
                                    </p>
                            ...
                            <div className="md:w-2/3">
                                <h3 className="text-base font-bold mb-4">Recent podcast episodes:</h3>
                                <div className="space-y-5">
                                    <div>
                                        <h4 className="font-bold mb-1 text-base">
                                            Corey Tun-Billson: Dollar Muffin — Inside Y Combinator's Startup Formula
                                        </h4>
                                    </div>
                                    <div>
                                        <h4 className="font-bold mb-1 text-base">Outliers: Henry Singleton — Cultural Force</h4>
                                    </div>
                                    <div>
                                        <h4 className="font-bold mb-1 text-base">Brad Taylor: A Vision For Art's Next Frontier</h4>
                                    </div>
                                    <div>
                                        <h4 className="font-bold mb-1 text-base">
                                    ...
                                    <div>
                                        <h4 className="font-bold mb-1 text-base">Outliers: Cornelius Vanderbilt—The First Tycoon</h4>
                                    </div>
                                </div>
                                <div className="mt-6 text-center">
                                    <Link href="#" className="text-red-600 text-sm inline-flex items-center">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 max-w-4xl mx-auto">
                            ...
                            <div className="md:w-2/3 text-left">
                                ...
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                    A proven framework for thinking clearly, no matter the situation.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <button className="bg-red-600 text-white px-6 py-2 rounded hover:bg-red-700 transition-colors">
                                        Order Now
                                    </button>
                                    <Link href="#" className="text-red-600 underline flex items-center">
                                        Learn more →
                                    </Link>
                                </div>
                            </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-8 py-8 border-t border-gray-800">
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Our free weekly newsletter with timeless insights.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <div className="mt-1 text-red-600">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Get early access to new articles.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <div className="mt-1 text-red-600">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Support our ad-free, paywall-free site.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <div className="mt-1 text-red-600">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Learn the mental models used by the world's top performers.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container mx-auto px-4 max-w-6xl">
                        <div className="flex flex-col md:flex-row items-center justify-between">
                            <div className="mb-4 md:mb-0">
                                ...
                                <p className="text-sm text-gray-400">Upgrade your mind in just 5 minutes a week.</p>
                            </div>
                ...
                <div className="border-t border-gray-800 py-6 text-xs text-gray-500">
                    <div className="container mx-auto px-4 max-w-6xl">
                        <div className="flex flex-col md:flex-row justify-between items-center">
                            <div className="mb-4 md:mb-0">
                                <Link href="/" className="text-red-600 font-serif font-bold text-lg">
                                    fs
                                </Link>
                                <span className="ml-2">© Farnam Street Media Inc. All Rights Reserved.</span>
                            </div>

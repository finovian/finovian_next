        ...
        <div className="fixed inset-0 bg-white z-50 overflow-y-auto">
          ...
          <nav className="p-4 flex flex-col space-y-6">
            ...
            <div className="pt-6 text-gray-700 leading-relaxed">
              <p className="mb-4">
                Our timeless insights for a complex Tuesday. Sunday
                understanding by 300,000+ independent thinkers.
              </p>

              <p className="mb-4">
                <span className="font-semibold">Bonus:</span> Download Chapter 1
                of my instant <span className="italic">New York Times</span>{" "}
                best-selling book,{" "}

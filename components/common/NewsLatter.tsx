        ...
        <div className="bg-[#0e1111] text-white font-serif px-6 py-16 md:px-12 lg:px-24">
            <div className="mx-auto max-w-[960px] w-full">
                ...
                <div className="flex justify-center items-center gap-8 flex-wrap">
                    <Image src="/NewYorkTimes.svg" alt="New York Times" width={100} height={24} className="h-6 opacity-80 hover:opacity-100 transition" />
                    <Image src="/WallStreetJournal.svg" alt="Wall Street Journal" width={100} height={24} className="h-6 opacity-80 hover:opacity-100 transition" />
                    <Image src="/NewYorkTimes.svg" alt="The Economist" width={100} height={24} className="h-6 opacity-80 hover:opacity-100 transition" />
                    <Image src="/FinancialTimes.svg" alt="Financial Times" width={100} height={24} className="h-6 opacity-80 hover:opacity-100 transition" />
                </div>
            </div>
        </div>
    )

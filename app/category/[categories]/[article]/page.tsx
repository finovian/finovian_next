...
// Use native NextJS types instead of custom ones
...
//         <PortableText value={parsedBody} components={components} />
//       </article> */}
//     </main>
//   );
// }
...
const Page = () => {
  return (
    <div className="bg-white text-[#141414]">
      {/* Header Image */}
      <div className="w-full h-[300px] bg-cover bg-center rounded-b-xl bg-[url('https://images.unsplash.com/photo-1639389016105-2fb11199fb6b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGNoYXJ0fGVufDB8fDB8fHww')]" />
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="space-y-6 text-base leading-loose text-neutral-800">
          ...
          <p>
            ...
            in 1990 and didn&apos;t touch it — not even during the Dot-com
            crash, the 2008 financial crisis, or COVID — would have seen their
            portfolio grow significantly.
          </p>

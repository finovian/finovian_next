...
import { generateMetadata as genMeta, generateArticleSchema, generateBreadcrumbSchema, siteConfig } from '@/lib/seo';
...
export default async function ArticlePage({ params }: Props) {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: resolvedParams.categories, url: `${siteConfig.url}/category/${resolvedParams.categories}` },
    { name: post.title, url: `${siteConfig.url}/category/${resolvedParams.categories}/${post.slug}` },
  ]);

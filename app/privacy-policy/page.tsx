        ...
        <div className="px-40 flex flex-1 justify-center py-5">
            <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
                ...
                <p className="text-[#141414] text-base font-normal leading-normal pb-3 pt-1 px-4">
                    ...
                    how we protect it. By using this site, you agree to this policy.
                </p>
                ...
                <div className="px-4">
                    ...
                    <label className="flex gap-x-3 py-3 flex-row">
                        ...
                        />
                        <p className="text-[#141414] text-base font-normal leading-normal">
                            Analytics data (including IP address, browser information, and device
                            information)
                        </p>
                    </label>
                    <label className="flex gap-x-3 py-3 flex-row">
                ...
                <p className="text-[#141414] text-base font-normal leading-normal pb-3 pt-1 px-4">
                    ...
                    deletion of your personal data. Contact us at the email below to exercise
                    these rights.
                </p>
                <h2 className="text-[#141414] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
                    Data Security
                ...
                <p className="text-[#141414] text-base font-normal leading-normal pb-3 pt-1 px-4">
                    We may update this privacy policy from time to time. Last updated on July
                    26, 2024.
                </p>
                <h2 className="text-[#141414] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
                    Contact

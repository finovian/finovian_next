...
export default function TermsAndConditions() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-[#1a1a1a]">
      ...
      <h2 className="mt-6 mb-2 text-xl font-semibold">1. Use License</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-6 mb-2 text-xl font-semibold">2. Disclaimer</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-6 mb-2 text-xl font-semibold">3. Financial Advice Disclaimer</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-6 mb-2 text-xl font-semibold">4. Limitations</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-6 mb-2 text-xl font-semibold">5. Accuracy of Content</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-6 mb-2 text-xl font-semibold">6. Affiliate Links</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-6 mb-2 text-xl font-semibold">7. Modifications</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-6 mb-2 text-xl font-semibold">8. Governing Law</h2>
      <p className="mb-4">
        These terms are governed by and construed in accordance with the laws of the United States,
        and you irrevocably submit to the jurisdiction of the courts in that location.
      </p>

      <h2 className="mt-6 mb-2 text-xl font-semibold">9. Contact Us</h2>
      <p>

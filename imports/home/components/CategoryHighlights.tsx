...
const categories = [
  {
    ...
    description:
      "Insights on individual companies, market trends, and investment opportunities.",
    icon: (
      <svg
  ...
  },
  {
    ...
    href: "/category/macro",
    description:
      "Analysis of global economic trends and their impact on financial markets.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    title: "Earnings",
    href: "/category/earnings",
    description:
      "Coverage of company earnings reports, forecasts, and market reactions.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {categories.map((cat) => (
          ...
          >
            <span className="text-[#141415]">{cat.icon}</span>

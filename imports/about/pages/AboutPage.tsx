  ...
  return (
    <>
      ...
      <p className="text-[#141414] text-base font-normal leading-normal pb-3 pt-1 px-4">
        ...
        simplifying complex financial concepts. This blog started as a personal
        project to document my own financial journey and share insights with
        others. My goal is to make finance accessible and actionable for
